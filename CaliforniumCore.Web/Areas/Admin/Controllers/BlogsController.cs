...
public class BlogsController : AdminControllerBase
{
    ...
    public async Task<IActionResult> Edit(int id, CancellationToken cancellationToken = default)
    {
        ...
        var model = new BlogAdminEditViewModel
        {
            ...
            VideoPreview = _videoEmbedService.BuildEmbed(entity.VideoUrl),
    ...
    public async Task<IActionResult> Details(int id, CancellationToken cancellationToken = default)
    {
        ...
        model.VideoPreview = _videoEmbedService.BuildEmbed(model.VideoUrl);
    ...
    private string? PrepareVideoUrl(BlogAdminEditViewModel model)
    {
