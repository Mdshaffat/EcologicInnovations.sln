...
using CaliforniumCore.Web.Data.Seed;
...
// Raise Kestrel + form-multipart limits to support media uploads (Media:MaxFileSizeMb = 10).
const long maxRequestSize = 15 * 1024 * 1024; // 15 MB
...
builder.Services.AddCaliforniumCoreSharedServices(builder.Configuration);
builder.Services.AddCaliforniumCoreSeoInfrastructure(builder.Configuration);
