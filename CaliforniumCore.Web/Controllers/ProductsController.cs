...
public class ProductsController : Controller
{
    ...
    private readonly IVideoEmbedService _videoEmbedService;
    ...
    public ProductsController(
        ...
        IVideoEmbedService videoEmbedService)
    {
        ...
        _videoEmbedService = videoEmbedService;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var visibleProductsQuery = _dbContext.Products
            .AsNoTracking()
        ...
        {
            visibleProductsQuery = visibleProductsQuery.Where(x =>
        ...
        var baseQuery = visibleProductsQuery;
        ...
        var allProductCount = await visibleProductsQuery.CountAsync(cancellationToken);
        ...
        var introText = selectedCategory is not null
            ? $"Browse {selectedCategory.Name.ToLowerInvariant()} solutions from Californium Core."
        ...
        var seo = new SeoMetaViewModel
        {
            ...
            Description = selectedCategory is not null
                ...
                : siteSettings.MetaDescriptionDefault ?? "Browse products from Californium Core.",
            ...
            OgDescription = selectedCategory is not null
                ? $"Browse {selectedCategory.Name.ToLowerInvariant()} products from {siteSettings.CompanyName}."
                : "Explore products from Californium Core.",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            ModelState.AddModelError("InquiryForm.Message", rateLimit.ErrorMessage ?? "Please try again later.");

            var limitedModel = await BuildProductDetailsViewModelAsync(slug, cancellationToken, input);
            if (limitedModel is null)
            {
                return NotFound();
            }

            limitedModel.InquirySubmittedSuccessfully = false;
            ViewData.SetSeoMeta(limitedModel.Seo);
            Response.StatusCode = StatusCodes.Status429TooManyRequests;
            return View("Details", limitedModel);
        }
        ...
        ContactFormInputModel? postedInput = null)
    {
        ...
        var model = new ProductDetailsViewModel
        {
            ...
            VideoEmbed = _videoEmbedService.BuildEmbed(product.VideoUrl),
