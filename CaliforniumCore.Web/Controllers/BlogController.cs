...
public class BlogController : Controller
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var introText = selectedCategory is not null
            ? $"Explore {selectedCategory.Name.ToLowerInvariant()} insights, updates, and practical knowledge from Californium Core."
            : "Read practical articles, solution insights, sustainability knowledge, and product-related updates from Californium Core.";
        ...
        var seo = new SeoMetaViewModel
        {
            ...
            Description = selectedCategory is not null
                ...
                : siteSettings.MetaDescriptionDefault ?? "Explore the latest articles and insights from Californium Core.",
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!rateLimit.IsAllowed)
        {
            ...
            var limitedModel = await BuildDetailsViewModelAsync(post.Id, cancellationToken, input);
            limitedModel.InquirySubmittedSuccessfully = false;
            ViewData["Seo"] = limitedModel.Seo;
            Response.StatusCode = StatusCodes.Status429TooManyRequests;
            return View(nameof(Details), limitedModel);
        }
        ...
        ContactFormInputModel? input = null)
    {
        ...
        return new BlogDetailsViewModel
        {
            ...
            VideoEmbed = _videoEmbedService.BuildEmbed(post.VideoUrl),
