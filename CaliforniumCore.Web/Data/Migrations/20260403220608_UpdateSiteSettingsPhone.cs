...
namespace CaliforniumCore.Web.Data.Migrations
{
    ...
    public partial class UpdateSiteSettingsPhone : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE SiteSettings SET Tagline = 'Software, intelligent connected systems, energy equipment, and core-ready digital solutions.' WHERE Tagline LIKE '%smart systems%'");
        }
    }
}
