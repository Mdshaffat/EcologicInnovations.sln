...
public class ContactMessageConfiguration : IEntityTypeConfiguration<ContactMessage>
{
    public void Configure(EntityTypeBuilder<ContactMessage> builder)
    {
        ...
        builder.Property(x => x.SubmitterDeviceId)
            .HasMaxLength(64);
        ...
        builder.HasIndex(x => new { x.SubmitterDeviceId, x.CreatedAt })
            .HasDatabaseName("IX_ContactMessages_SubmitterDeviceId_CreatedAt");
    }
}
