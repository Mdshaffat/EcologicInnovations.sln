...
public class BlogPost : BaseEntity
{
    ...
    /// </summary>
    [StringLength(500)]
    [CaliforniumCore.Web.Validation.RelativeOrAbsoluteUrl]
    public string? FeatureImageUrl { get; set; }

    /// <summary>
    /// Optional video URL shown as the main explainer media on the article details page.
    /// Supports known embeds such as YouTube/Vimeo and falls back to an external link.
    /// </summary>
    [StringLength(1000)]
