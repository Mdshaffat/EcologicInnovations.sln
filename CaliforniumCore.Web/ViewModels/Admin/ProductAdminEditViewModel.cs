...
public class ProductAdminEditViewModel
{
    ...
    /// <summary>
    /// Optional explainer video URL. Supported providers embed automatically.
    /// </summary>
    [StringLength(1000)]
    ...
    public CaliforniumCore.Web.ViewModels.Shared.VideoEmbedViewModel? VideoPreview { get; set; }
}
