...
public class ProductAdminListViewModel
{
    ...
    /// <summary>
    /// Total products currently visible on the public site.
    /// </summary>
    public int PubliclyVisibleCount { get; set; }

    /// <summary>
    /// Total products hidden from the public site because they are draft or inactive.
    /// </summary>
    public int HiddenFromPublicCount { get; set; }
