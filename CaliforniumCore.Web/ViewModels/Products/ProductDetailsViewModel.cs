...
namespace CaliforniumCore.Web.ViewModels.Products;
...
public class ProductDetailsViewModel
{
    ...
    /// <summary>
    /// Optional safe video embed shown instead of the main image on the details page.
    /// </summary>
    public VideoEmbedViewModel? VideoEmbed { get; set; }
