...
namespace CaliforniumCore.Web.ViewModels.Contact;
...
public class ContactPageViewModel
{
    ...
    /// <summary>
    /// Optional banner image URL shown behind the hero section.
    /// </summary>
    public string? BannerImageUrl { get; set; }

    /// <summary>
    /// Optional admin-managed rich HTML content shown above the contact form.
    /// </summary>
